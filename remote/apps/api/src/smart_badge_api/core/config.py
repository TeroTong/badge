...
class Settings(BaseSettings):
    ...
    dingtalk_audio_sync_enabled: bool = True
    ...
    dingtalk_audio_archive_sync_enabled: bool = True
    ...
    visit_order_auto_sync_enabled: bool = True
    ...
    asr_hotword_auto_sync_enabled: bool = True
