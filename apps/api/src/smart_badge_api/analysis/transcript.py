    ...
    for item in utterances:
        ...
        segments.append(
            _apply_speaker_role_correction({
                ...
                "speaker_display_label": _clean_text(item.get("speaker_display_label")),
                ...
                "speaker_role_source": _clean_text(item.get("speaker_role_source")),
                "speaker_identity_type": _clean_text(item.get("speaker_identity_type")),
                "speaker_staff_id": _clean_text(item.get("speaker_staff_id")),
                "speaker_staff_name": _clean_text(item.get("speaker_staff_name")),
                "asr_original_speaker": _clean_text(item.get("asr_original_speaker")),
                "asr_original_speaker_id": _clean_text(item.get("asr_original_speaker_id")),
                "speaker_diarization_source": _clean_text(item.get("speaker_diarization_source")),
